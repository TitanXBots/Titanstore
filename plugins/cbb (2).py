...
async def cb_handler(client: Bot, query: CallbackQuery):
    ...
    # -------------------------------
        ...
        if not is_admin_user:
            await query.message.edit_text(
                "❌ You are not authorized to access the Settings panel.",
    ...
    # -------------------------------
        ...
        if not is_admin_user:
            await query.message.edit_text(
                "❌ You are not authorized to access the Ban Menu.",
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚓ Home", callback_data="start")]])
            )
            return
    ...
    # -------------------------------
        ...
        if not is_admin_user:
            await query.message.edit_text(
                "❌ You are not authorized to ban users.",
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚓ Home", callback_data="start")]])
            )
            return
    ...
    # -------------------------------
        ...
        if not is_admin_user:
            await query.message.edit_text(
                "❌ You are not authorized to unban users.",
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚓ Home", callback_data="start")]])
            )
            return
    ...
    # -------------------------------
        ...
        if not is_admin_user:
            await query.message.edit_text(
                "❌ You are not authorized to view the banned list.",
                reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("⚓ Home", callback_data="start")]])
            )
            return
