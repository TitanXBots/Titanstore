...
@Client.on_callback_query(filters.regex("^(settings|protect_menu|protect_on|protect_off|forcesub_on|forcesub_off|global_db_menu|global_db_set|global_fs_menu|global_fs_set|add_channels_menu|admin_panel)$"))
async def settings_cb(client: Client, query: CallbackQuery):
    ...
    if data in ["settings", "admin_panel"]:
