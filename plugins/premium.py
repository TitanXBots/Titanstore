...
async def premium_callbacks(client: Client, query: CallbackQuery):
    ...
    if data == "premium_menu":
        ...
        text = await get_input(client, query.message, "ꜱᴇɴᴅ ᴜꜱᴇʀ_ɪᴅ ᴀɴᴅ ɴᴜᴍʙᴇʀ ᴏꜰ ᴅᴀʏꜱ (ꜱᴘᴀᴄᴇ ꜱᴇᴘᴀʀᴀᴛᴇᴅ). ᴇxᴀᴍᴘʟᴇ: '123456789 30'. ꜱᴇɴᴅ /Cancel ᴛᴏ ꜱᴛᴏᴘ ᴛʜɪꜱ ᴘʀᴏᴄᴇꜱꜱ", keyboard)
        if not text: return 
        parts = text.split()
        ...
        text = await get_input(client, query.message, "ꜱᴇɴᴅ ᴜꜱᴇʀ_ɪᴅ ᴛᴏ ʀᴇᴠᴏᴋᴇ ᴘʀᴇᴍɪᴜᴍ ᴀᴄᴄᴇꜱꜱ. ꜱᴇɴᴅ /Cancel ᴛᴏ ꜱᴛᴏᴘ ᴛʜɪꜱ ᴘʀᴏᴄᴇꜱꜱ", keyboard)
        if not text: return 
