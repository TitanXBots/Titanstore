...
async def render_dashboard(client, message, user_id):
    ...
    if is_prem or await is_admin(user_id):
        ...
        text = (
            ...
            f"📊 **ꜱᴛᴀᴛᴜꜱ:** {status}\n🪙 **ᴘᴏɪɴᴛꜱ:** {points}/{POINTS_TO_PREMIUM}\n\n"
            f"🎁 **ʜᴏᴡ ᴛᴏ ɢᴇᴛ ꜰʀᴇᴇ ᴘʀᴇᴍɪᴜᴍ?**\nꜱʜᴀʀᴇ ʏᴏᴜʀ ʟɪɴᴋ & ɢᴇᴛ 10 ᴘᴏɪɴᴛꜱ ᴘᴇʀ ɴᴇᴡ ᴜꜱᴇʀ.\n"
        ...
        if not await has_claimed_trial(user_id):
            text = "😔 **YOU DON'T HAVE ANY PREMIUM SUBSCRIPTION. IF YOU WANT TO BUY PREMIUM CLICK ON BELOW BUTTON.**\n\n**TO USE OUR PREMIUM FEATURES FOR 10 MINUTES CLICK ON FREE TRAIL BUTTON.**"
            buttons = [
